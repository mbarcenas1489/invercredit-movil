...
public class solicitud_credito extends BaseModel {
  @Column
  ...
  public int getCliente_existente() {
    return cliente_existente;
  }

  public void setCliente_existente(int cliente_existente) {
    this.cliente_existente = cliente_existente;
  }

  @Column
  private int cliente_existente;
