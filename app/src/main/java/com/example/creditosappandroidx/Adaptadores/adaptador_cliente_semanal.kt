...
class adaptador_cliente_semanal(var context: Context?, var listacompleta:MutableList<creditocliente>) : BaseAdapter()  {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
      ...
      /*  vh.contrain.setOnClickListener {
        ...
        //Dia de pago
        vh.tvdiaPago.setText(datospublicoskt.diasSemanas.get(c.dia_pago1))
        if(datospublicoskt.getDayOfTWeek()==c.dia_pago1)
        {
