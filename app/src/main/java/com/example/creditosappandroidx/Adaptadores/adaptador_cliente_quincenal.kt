...
class adaptador_cliente_quincenal(var context: Context?, var listacompleta: MutableList<creditocliente>) : BaseAdapter() {
  ...
  override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
    ...
    vh.tvdiaPago.setText(c?.dia_pago1.toString() + "-" + c?.dia_pago2.toString())
    if (datospublicoskt.getDayOfTMonth() == c?.dia_pago1 || datospublicoskt.getDayOfTMonth() == c?.dia_pago2) {
